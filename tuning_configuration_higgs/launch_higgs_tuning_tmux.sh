...
CONFIGS=(
    "01_tuning_higgs_mlps_l1.yaml"
    "02_tuning_higgs_mlps_l2.yaml"
    "03_tuning_higgs_mlps_scfe.yaml"
    "04_tuning_higgs_mlps_earlystop.yaml"
    "05_tuning_higgs_mlps_dropout.yaml"
    "06_tuning_higgs_mlpb_l1.yaml"
    "07_tuning_higgs_mlpb_l2.yaml"
    "08_tuning_higgs_mlpb_scfe.yaml"
    "09_tuning_higgs_mlpb_earlystop.yaml"
    "10_tuning_higgs_mlpb_dropout.yaml"
)
